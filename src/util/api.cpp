...
namespace Hermes
{
  ...
  Api::Api()
  {
    ...
    this->parameters.insert(std::pair<HermesCommonApiParam, Parameter*> (Hermes::matrixSolverType, new Parameter(0)));
  }
  ...
  static Hermes::Api HermesCommonApiInstance;

  Hermes::Api& HermesCommonApi()
  {
    return HermesCommonApiInstance;
  }
}